...
// only NEXT arrow (Figma me sirf right side arrow hai)
...
export default function DoctorCareSlider({ items = providers }) {
  const settings = {
    ...
    infinite: true,
    speed: 550,
    slidesToShow: 4, // Figma: 4 cards visible
    slidesToScroll: 1,
    centerMode: false,
    autoplay: true,
    autoplaySpeed: 4200,
    ...
    // outer ring + inner circle (same feel as Figma)
    customPaging: () => (
  ...
  return (
    <section className="py-10 bg-white">
      ...
      {/* Slider overrides for dots + arrow, Figma-style */}
      <style>{`
