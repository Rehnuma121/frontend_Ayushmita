        ...
        <div className="grid gap-8 md:grid-cols-2 ">
          {hospitalData.map((countryBlock, idx) => (
            <div
              ...
              className="relative bg-[#F8F8F8] rounded-2xl p-6 md:p-7 border border-gray-100 "
            >
              {/* Card header */}
              ...
              <button className="mt-6 w-full py-3 rounded-lg bg-amber-500 text-black text-sm font-semibold hover:bg-amber-600 transition"
                style={{
                  ...
                  lineHeight: '100%',
                  letterSpacing: '2%',
                  backgroundColor: '#F0A324', // Overrides Tailwind bg-amber-500
