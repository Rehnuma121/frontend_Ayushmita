                ...
                <div>
                  <div className="highlight"
                    style={{
                      ...
                      fontStyle: 'normal',       // SemiBold is handled via fontWeight
                      fontSize: '24px',
                      lineHeight: '33.6px',
                      letterSpacing: '0%',
                      textAlign: 'center',
                ...
                return (
                  <div key={f.id}>
                    ...
                    >
                      ...
                      <span
                        className={`flex-shrink-0 w-8 h-8 rounded-full bg-white  flex items-center justify-center text-amber-500 transition-transform ${isOpen ? "rotate-45" : ""
                          }`}
                      >
                        <svg
                          className="w-4 h-4"
                    ...
                    <div
                      id={`faq-panel-${f.id}`}
                      role="region"
                      className={`mt-2 px-6 overflow-hidden transition-all duration-300 ${isOpen ? "max-h-40 opacity-100" : "max-h-0 opacity-0"
                        }`}
